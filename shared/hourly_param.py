...
class ForecastHourlyParam(HourlyWeatherParam):
    WIND_SPEED_80M = WeatherParam("wind_speed_80m", "km/h (mph, m/s, knots)")
    WIND_SPEED_120M = WeatherParam("wind_speed_120m", "km/h (mph, m/s, knots)")
    WIND_SPEED_180M = WeatherParam("wind_speed_180m", "km/h (mph, m/s, knots)")
    WIND_DIRECTION_80M = WeatherParam("wind_direction_80m", "°")
    WIND_DIRECTION_120M = WeatherParam("wind_direction_120m", "°")
    WIND_DIRECTION_180M = WeatherParam("wind_direction_180m", "°")
    CAPE = WeatherParam("cape", "J/kg")
    PRECIPITATION_PROBABILITY = WeatherParam("precipitation_probability", "%")
    SHOWERS = WeatherParam("showers", "mm (inch)")
    FREEZING_LEVEL_HEIGHT = WeatherParam("freezing_level_height", "meters")
    VISIBILITY = WeatherParam("visibility", "meters")
    SOIL_TEMPERATURE_0CM = WeatherParam("soil_temperature_0cm", "°C (°F)")
    SOIL_TEMPERATURE_6CM = WeatherParam("soil_temperature_6cm", "°C (°F)")
    SOIL_TEMPERATURE_18CM = WeatherParam("soil_temperature_18cm", "°C (°F)")
    SOIL_TEMPERATURE_54CM = WeatherParam("soil_temperature_54cm", "°C (°F)")
    SOIL_MOISTURE_0_TO_1CM = WeatherParam("soil_moisture_0_to_1cm", "m³/m³")
    SOIL_MOISTURE_1_TO_3CM = WeatherParam("soil_moisture_1_to_3cm", "m³/m³")
    SOIL_MOISTURE_3_TO_9CM = WeatherParam("soil_moisture_3_to_9cm", "m³/m³")
    SOIL_MOISTURE_9_TO_27CM = WeatherParam("soil_moisture_9_to_27cm", "m³/m³")
    SOIL_MOISTURE_27_TO_81CM = WeatherParam("soil_moisture_27_to_81cm", "m³/m³")
    IS_DAY = WeatherParam("is_day", "")